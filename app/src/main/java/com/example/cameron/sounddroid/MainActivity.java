package com.example.cameron.sounddroid;
...
import com.example.cameron.sounddroid.com.example.cameron.sounddroid.soundcloud.SoundCloud;
import com.example.cameron.sounddroid.com.example.cameron.sounddroid.soundcloud.SoundCloudService;
import com.example.cameron.sounddroid.com.example.cameron.sounddroid.soundcloud.Track;
...
public class MainActivity extends ActionBarActivity implements SearchView.OnQueryTextListener {
    ...
    private void toggleSongState() {
        if (mMediaPlayer.isPlaying()) {
            Log.d(TAG, "state is working");
            mMediaPlayer.pause();
            mPlayerStateButton.setImageResource(R.drawable.ic_play);
        } else {
            Log.d(TAG, "state ain't working");
            mMediaPlayer.start();
